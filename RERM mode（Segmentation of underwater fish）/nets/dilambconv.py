...
class MBConvBlock(nn.Module):
    ...
    def __init__(self, ksize, input_filters, output_filters, expand_ratio=1, stride=1, image_size=224):
        ...
        self.dilatconv = nn.Sequential(
            nn.Conv2d(inp, oup, kernel_size=3, stride=1, padding=3, dilation=3, bias=True),
...
if __name__ == '__main__':
    input=torch.randn(2, 320, 32, 32)
    mbconv=MBConvBlock(ksize=3,input_filters=320,output_filters=320,image_size=32)
    out=mbconv(input)
    print(out.shape)
